		...
		if ($this->form_validation->run()) {
			...
			if ($save_menu) {
				if ($this->input->post('save_type') == 'stay') {
					...
					$this->data['message'] = 'Your data has been successfully stored into the database. '.anchor('administrator/menu/edit/' . $save_menu, 'Edit Blog').' or  '.anchor('administrator/menu', ' Go back to list');
				} else {
					set_message('Your data has been successfully stored into the database. '.anchor('administrator/blog/edit/' . $save_menu, 'Edit Blog').' or  '.anchor('administrator/menu', ' Go back to list'), 'success');
	...
	public function edit_save($id)
	{
		...
		if ($this->form_validation->run()) {
			...
			if ($save_menu) {
				$this->data['success'] = true;
				$this->data['id'] 	   = $id;
				$this->data['message'] = 'Your data has been successfully updated into the database. '.anchor('administrator/menu', ' Go back to list');
			} else {
				$this->data['success'] = false;
				$this->data['message'] = 'Data not change ';
			}
