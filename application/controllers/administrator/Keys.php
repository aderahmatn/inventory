        ...
        if ($this->form_validation->run()) {
            ...
            if ($save_keys) {
                if ($this->input->post('save_type') == 'stay') {
                    ...
                    $this->data['message'] = 'Your data has been successfully stored into the database. ' . anchor('administrator/keys/edit/' . $save_keys, 'Edit Keys') . ' or  ' . anchor('administrator/keys', ' Go back to list');
                } else {
                    set_message('Your data has been successfully stored into the database. ' . anchor('administrator/keys/edit/' . $save_keys, 'Edit Keys'));
        ...
        if ($this->form_validation->run()) {
            ...
            if ($save_keys) {
                if ($this->input->post('save_type') == 'stay') {
                    $this->data['success'] = true;
                    $this->data['id']      = $id;
                    $this->data['message'] = 'Your data has been successfully updated into the database. ' . anchor('administrator/keys', ' Go back to list');
                } else {
