		...
		if ($this->form_validation->run()) {
			...
			if ($save_user) {
				...
				if ($this->input->post('save_type') == 'stay') {
					...
					$this->response['message'] = 'Your data has been successfully stored into the database. '.anchor('administrator/user/edit/' . $save_user, 'Edit Permission').' or  '.anchor('administrator/user', ' Go back to list');
				} else {
					set_message('Your data has been successfully stored into the database. '.anchor('administrator/user/edit/' . $save_user, 'Edit User'));
	        		$this->response['success'] = true;
