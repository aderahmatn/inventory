		...
		if ($this->form_validation->run()) {
			...
			if ($save_page) {
				if ($this->input->post('save_type') == 'stay') {
					...
					$this->data['message'] = 'Your data has been successfully stored into the database. '.anchor('administrator/page/edit/' . $save_page, 'Edit Page').' or  '.anchor('administrator/page', ' Go back to list');
				} else {
					set_message('Your data has been successfully stored into the database. '.anchor('administrator/page/edit/' . $save_page, 'Edit Page'), 'success');
		...
		if ($this->form_validation->run()) {
			...
			if ($save_page) {
				if ($this->input->post('save_type') == 'stay') {
					$this->data['success'] = true;
					$this->data['id'] 	   = $id;
					$this->data['message'] = 'Your data has been successfully updated into the database. '.anchor('administrator/page', ' Go back to list');
				} else {
