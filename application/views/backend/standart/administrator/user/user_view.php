            ...
            <div class="box-body ">
                  ...
                  <div class="col-md-12">
                   ...
                   <div class="row-fluid col-md-12" >
                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="back (Ctrl+x)" href="<?= site_url('administrator/user/'); ?>"><i class="fa fa-undo" ></i> Go User List</a>
                        <?php is_allowed('user_update', function($u) use ($user){?>
                        <a class="btn btn-flat btn-info btn-warning btn_edit btn_action" id="btn_edit" data-stype='back' title="edit user (Ctrl+e)" href="<?= site_url('administrator/user/edit/'.$user->id); ?>"><i class="fa fa-edit" ></i> Edit User</a>
                        <?php }) ?>
                  </div>
            </div>
            <!--/box body -->
