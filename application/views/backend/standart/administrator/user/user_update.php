                   ...
                   <div class="form-group ">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-6">
                          ...
                          <input type="password" class="form-control password" name="password" id="password" placeholder="Password" value="<?= set_value('password'); ?>">
                           ...
                           <small class="info help-block">
                             do not be fill if you do not want to change the password, <br>The password character must 6 or more.
                          </small>
                        </div>
                    </div>
                    <?php }) ?>
                    ...
                    <div class="message">
                     ...
                     <div class="row-fluid col-md-7">
                        <button class="btn btn-flat btn-primary btn_save btn_action disabled" id="btn_save" data-stype='stay' title="save (Ctrl+s)"><i class="fa fa-save" ></i> Save</button>
