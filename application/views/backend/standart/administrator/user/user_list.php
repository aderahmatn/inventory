            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="add new user (Ctrl+a)" href="<?= site_url('administrator/user/add'); ?>"><i class="fa fa-plus-square-o" ></i> Add New User</a>
                        <?php }) ?>
                        <?php is_allowed('user_export', function(){?>
                        <a class="btn btn-flat btn-success" title="export user" href="<?= site_url('administrator/user/export'); ?>"><i class="fa fa-file-excel-o" ></i> Export</a>
                        <?php }) ?>
                        <?php is_allowed('user_export', function(){?>
                        <a class="btn btn-flat btn-success" title="export pdf User" href="<?= site_url('administrator/user/export_pdf'); ?>"><i class="fa fa-file-pdf-o" ></i> Export PDF</a>
                        <?php }) ?>
                     ...
                     <h5 class="widget-user-desc">List All User <i class="label bg-yellow"><?= $user_counts; ?>  items</i></h5>
                  </div>
                  ...
                  <table class="table table-bordered table-striped dataTable">
                     ...
                     <?php foreach($users as $user): ?>
                        <tr>
                           ...
                           <td width="200">
                              <?php is_allowed('user_view', function($u) use ($user){?>
                                <a href="<?= site_url('administrator/user/view/' . $user->id); ?>" class="label-default"><i class="fa  fa-newspaper-o "></i> View</a>
                              <?php }) ?>
                              <?php is_allowed('user_update', function($u) use ($user){?>
                              <a href="<?= site_url('administrator/user/edit/' . $user->id); ?>" class="label-default"><i class="fa fa-edit "></i> Update</a>
                              <?php }) ?>
                              <?php is_allowed('user_delete', function($u) use ($user){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/user/delete/' . $user->id); ?>" class="label-default remove-data"><i class="fa fa-close"></i> Remove</a>
                              <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-2 padd-left-0 ">
                        <button type="button" class="btn btn-flat"  name="apply" id="apply" value="Apply" title="apply bulk actions">Apply</button>
                     </div>
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/user'); ?>" title="reset filters">
