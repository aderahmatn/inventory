...
<section class="content-header">
    <h1>
        Departemen        <small>New Departemen</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Departemen</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        <div class="form-group ">
                            <label for="kode_dep" class="col-sm-2 control-label">Kode Departemen 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kode_dep" id="kode_dep" placeholder="Kode Departemen" value="<?= set_value('kode_dep'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
