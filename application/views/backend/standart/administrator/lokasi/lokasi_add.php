                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Lokasi</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_lokasi', 
                         ...
                         <div class="form-group ">
                            <label for="kode_lok" class="col-sm-2 control-label">Kode Lokasi 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kode_lok" id="kode_lok" placeholder="Kode Lokasi" value="<?= set_value('kode_lok'); ?>">
