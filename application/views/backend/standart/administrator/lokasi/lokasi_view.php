            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-horizontal" name="form_lokasi" id="form_lokasi" >
                    ...
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Kode Lok </label>

                        <div class="col-sm-8">
                           <?= _ent($lokasi->kode_lok); ?>
                        </div>
                    </div>
                    ...
                    <div class="view-nav">
                        ...
                        <?php }) ?>
                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="back (Ctrl+x)" href="<?= site_url('administrator/lokasi/'); ?>"><i class="fa fa-undo" ></i> Go Lokasi List</a>
                     </div>
