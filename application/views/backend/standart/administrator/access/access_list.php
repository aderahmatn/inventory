            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <h5 class="widget-user-desc">List All Access</h5>
                  </div>
                </div>
                      ...
                      <div class="nav-tabs-custom">
                        ...
                        <?php endforeach; ?>
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li role="presentation"><a role="menuitem" tabindex="-1" href="<?= site_url('administrator/group/add'); ?>">Add New Group</a></li>
                              <?php endif; ?>
                              <?php if ($this->aauth->is_allowed('group_list')): ?>
                              <li role="presentation"><a role="menuitem" tabindex="-1" href="<?= site_url('administrator/group'); ?>">View All Group</a></li>
                              <?php endif; ?>
                            </ul>
                          </li>
                        ...
                        <div class="tab-content">
                          <div class="tab-pane active" id="tab_1">
                            <label><input type="checkbox" class="flat-red toltip" id="check_all" name="check_all" title="check all"> Check All</label> <input type="text" id="search" name="search" placeholder="Filter access">
