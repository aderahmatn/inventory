...
<section class="content-header">
    <h1>
        Jenis Pengadaan        <small>New Jenis Pengadaan</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Jenis Pengadaan</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        <div class="form-group ">
                            <label for="kode_pengadaan" class="col-sm-2 control-label">Kode Pengadaan 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kode_pengadaan" id="kode_pengadaan" placeholder="Kode Pengadaan" value="<?= set_value('kode_pengadaan'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
