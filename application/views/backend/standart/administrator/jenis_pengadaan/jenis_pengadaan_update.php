                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kode_pengadaan" id="kode_pengadaan" placeholder="Kode Pengadaan" value="<?= set_value('kode_pengadaan', $jenis_pengadaan->kode_pengadaan); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
