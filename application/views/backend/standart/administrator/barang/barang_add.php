                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Barang</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_barang', 
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="usia_barang" id="usia_barang" placeholder="Usia Barang" value="<?= set_value('usia_barang'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            <label for="nilai_residu" class="col-sm-2 control-label">Nilai Residu Barang 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="nilai_residu" id="nilai_residu" placeholder="Nilai Residu Barang" value="<?= set_value('nilai_residu'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="kategori" id="kategori" data-placeholder="Select Kategori" >
                                    ...
                                    <option value="<?= $row->kode_kategori ?>"><?= $row->kode_kategori; ?>-<?= $row->katerogi; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="kondisi" id="kondisi" data-placeholder="Select Kondisi" >
                                    ...
                                    <option value="<?= $row->nama_kondisi ?>"><?= $row->nama_kondisi; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
