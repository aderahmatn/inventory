                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Mutasi</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_mutasi', 
                            ...
                            <label for="id_penempatan" class="col-sm-2 control-label">Cari id Penempatan Awal
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_penempatan" id="id_penempatan" data-placeholder="Select Id Penempatan" >
                                    <option value=""></option>
