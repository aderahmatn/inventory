               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-horizontal" name="form_penempatan" id="form_penempatan" >
                    ...
                    <div class="view-nav">
                        ...
                        <?php }) ?>
                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="back (Ctrl+x)" href="<?= site_url('administrator/penempatan/'); ?>"><i class="fa fa-undo" ></i> Go Penempatan List</a>
                     </div>
