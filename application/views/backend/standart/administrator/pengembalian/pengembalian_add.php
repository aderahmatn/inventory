...
<section class="content-header">
    <h1>
        Pengembalian        <small>New Pengembalian</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Pengembalian</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="departemen_peminjam" id="departemen_peminjam" data-placeholder="Select Departemen Peminjam" >
                                    <option value=""></option>
