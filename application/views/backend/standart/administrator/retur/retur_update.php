...
<section class="content-header">
    <h1>
        Return        <small>Edit Return</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Return</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/retur/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="penerima_barang" id="penerima_barang" data-placeholder="Select Penerima Barang" >
                                    <option value=""></option>
      ...
      $('.btn_save').click(function(){
       ...
       $('#retur_berkas_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/retur/get_berkas_file/<?= $retur->id_return; ?>',
