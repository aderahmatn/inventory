...
<section class="content-header">
    <h1>
        Kategori        <small>New Kategori</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Kategori</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_kategori', 
                        ...
                        <div class="form-group ">
                            <label for="katerogi" class="col-sm-2 control-label">Kategori 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="katerogi" id="katerogi" placeholder="Kategori" value="<?= set_value('katerogi'); ?>">
                        ...
                        <div class="form-group ">
                            <label for="kode_kategori" class="col-sm-2 control-label">Kode Kategori 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kode_kategori" id="kode_kategori" placeholder="Kode Kategori" value="<?= set_value('katerogi'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
