...
--
-- Host: localhost:3306
-- Waktu pembuatan: 27 Bulan Mei 2020 pada 10.04
...
(5, 'Unit', 'Unit yang bisa melakukan peminjaman saja'),
(6, 'Keuangan', 'Yang mengakses pengadaan barang saja untuk melihat pengeluaran biaya');
...
(50, '140.0.164.175', '2019-12-19 09:20:33', 3),
(54, '116.197.135.186', '2020-01-17 08:02:45', 1),
(77, '116.197.135.186', '2020-01-27 16:51:12', 1);
...
(1, 'admin@domain.com', '3783a5063e48003fd64eb62d2f06125430b4d63e62aeda455564932654079c80', 'admin', 'admin', '', 0, '2020-05-27 10:03:14', '2020-05-27 10:03:14', '2018-07-18 13:31:09', NULL, '2020-03-15 00:00:00', '8IqQmvP3orhJ6KTf', NULL, NULL, '140.213.10.44'),
(5, 'goldlionstore@gmail.com', '0ffdf1753b9bd00b67ace168ae3a66bda7a89e3e1fdf763b3e9fe256645e1d28', 'goldlion', 'Gold Lion', '', 0, '2019-11-07 10:15:59', '2019-11-07 10:15:59', '2019-10-30 10:11:09', NULL, NULL, NULL, NULL, NULL, '125.165.208.42');
...
CREATE TABLE `barang` (
  ...
  `usia_barang` varchar(100) NOT NULL,
  `nilai_residu` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'Blog Pertama Saya', 'Ini adalah blog pertama saya', '20180718202127-2018-07-18blog202114.jpg', 'Technology', '2018-07-18 13:00:00');
...
(31, 1583986775, '36.73.74.234', 'Q9NC'),
(32, 1583986787, '36.73.74.234', 'VC35');
...
(3, 'site_name', 'Aplikasi Inventaris'),
(4, 'email', 'goldlionstore@gmail.com'),
(5, 'author', ''),
(6, 'site_description', ''),
(7, 'keywords', ''),
(8, 'landing_page_id', '1');
...
(19, 'Return', 'Return', 'retur', 'id_return', 'yes', 'yes', 'yes'),
...
--
-- Dumping data untuk tabel `form_pengajuan_pinjam_barang`
--

INSERT INTO `form_pengajuan_pinjam_barang` (`id`, `nik_nidn_nim`, `nama_peminjam`, `no_telp_hp`, `nama_barang`, `dipakai_di`, `digunakan_untuk`, `jumlah`, `tanggal_pinjam`, `tanggal_kembali`) VALUES
(1, '3521354314354', 'Tio Panji Mahardika, S. Kom', '567567567', 'Mouse', 'IT', 'fyhfghfg', '5', '2018-07-23 10:05:27', '2018-07-24');
...
(3, 'Puket II'),
(4, 'Puket III'),
(5, 'Kaprodi S1 Ilmu Keperawatan'),
(6, 'Kaprodi DIII Keperawatan'),
(7, 'Kaprodi DIII Kebidanan'),
(8, 'Kaprodi DIV Bidan Pendidik'),
(9, 'Kaprodi Ners'),
(10, 'Kabag IT'),
(11, 'Kabag BAAK'),
(12, 'Kabag LPM'),
...
(20, 'Satpam'),
(21, 'Kebun'),
(22, 'Mahasiswa S1 Ilmu Keperawatan'),
(23, 'Mahasiswa DIV Bidan Pendidik'),
(24, 'Mahasiswa Profesi Ners'),
(25, 'Mahasiswa DIII Keperawatan'),
(26, 'Mahasiswa DIII Kebidanan');
...
INSERT INTO `jenis_pengadaan` (`id_jenis_pendagaan`, `kode_pengadaan`, `jenis_pengadaan`, `keterangan`) VALUES
(1, 'bli', 'Pembelian', '');
...
INSERT INTO `karyawan` (`id_karyawan`, `nama_lengkap`, `telp`, `nik`, `jabatan`) VALUES
(6, 'Murjana', '0855665566', '123456789', 'Karyawan'),
(7, 'Putu Agus', '025354851215', '543233445435345', 'Karyawan'),
(9, 'Sapoy Corp', '082330726906', '1234346354324', 'Puket I');
...
INSERT INTO `kategori` (`id_kategori`, `kode_kategori`, `katerogi`, `keterangan`) VALUES
(17, 'COMP', 'COMPUTER', '');
...
INSERT INTO `kondisi` (`id_kon`, `nama_kondisi`) VALUES
(1, 'Baru'),
(2, 'Rusak');
...
(1, 'MAIN NAVIGATION', 'label', '', 'administrator/dashboard', 1, 0, '', 1),
(2, 'Dashboard', 'menu', '', 'administrator/dashboard', 2, 0, 'fa-dashboard', 1),
(8, 'Akun', 'menu', 'default', '#', 28, 0, 'fa-shield', 1),
(9, 'User', 'menu', '', 'administrator/user', 29, 8, '', 1),
(10, 'Groups', 'menu', '', 'administrator/group', 30, 8, '', 1),
(11, 'Access', 'menu', '', 'administrator/access', 31, 8, '', 1),
(14, 'Kofigurasi', 'menu', 'default', '#', 32, 0, 'fa-cogs', 1),
(15, 'Settings', 'menu', 'text-red', 'administrator/setting', 33, 14, 'fa-circle-o', 1),
(18, 'Home', 'menu', 'default', '/', 1, 0, '', 2),
(21, 'Dashboard', 'menu', '', 'administrator/dashboard', 4, 0, '', 2),
(23, 'Master Data', 'menu', 'default', '#', 3, 0, 'fa-database', 1),
(32, 'Peminjaman', 'menu', 'default', '#', 19, 0, 'fa-edit', 1),
(33, 'Input Peminjaman', 'menu', 'default', 'administrator/pengajuan/add', 20, 32, '', 1),
(34, 'View', 'menu', 'default', 'administrator/pengajuan', 21, 32, '', 1),
(35, 'Pengembalian', 'menu', 'default', '#', 22, 0, 'fa-mail-reply', 1),
(36, 'Input Barang Kembali', 'menu', 'default', 'administrator/pengembalian/add', 23, 35, '', 1),
(37, 'View', 'menu', 'default', 'administrator/pengembalian', 24, 35, '', 1),
(41, 'Return', 'menu', 'default', 'administrator/retur', 25, 0, 'fa-car', 1),
(42, 'Input Return', 'menu', 'default', 'administrator/retur/add', 26, 41, '', 1),
(43, 'View', 'menu', 'default', 'administrator/retur', 27, 41, '', 1),
...
(60, 'Input Mutasi', 'menu', 'default', 'administrator/mutasi/add', 17, 59, '', 1),
(61, 'View', 'menu', 'default', 'administrator/mutasi', 18, 59, '', 1),
(62, 'Kondisi Barang', 'menu', 'default', 'administrator/kondisi', 6, 23, NULL, 1);
...
INSERT INTO `ruangan` (`id_ruangan`, `ruangan`, `deskripsi`) VALUES
(9, 'Perlengkapan', '');
...
ALTER TABLE `lokasi`
  ...
  ADD UNIQUE KEY `kode_lok` (`kode_lok`);
...
--
ALTER TABLE `captcha`
  MODIFY `captcha_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `jenis_pengadaan`
  MODIFY `id_jenis_pendagaan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `kondisi`
  MODIFY `id_kon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `lokasi`
--
ALTER TABLE `lokasi`
  MODIFY `id_lok` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `mutasi`
  MODIFY `id_mutasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `penempatan`
  MODIFY `id_penempatan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
